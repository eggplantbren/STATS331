...
When we solve real data analysis problems with JAGS, we won't have to think too
...
states $i$ and $j$ respectively. The transition probability is the probability
