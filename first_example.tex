...
idea for this question was based on an example in David MacKay's book
...
the phone number, you will definitely hear a busy signal because you are calling yourself.
If you are incorrect, the probability of hearing a busy signal is $1/100$.
When you do the experiment, you do in fact hear a busy signal. Let $C$ be the
hypothesis that {\tt 555-3226} is the correct phone number,
and let $B$ be the event of hearing a busy signal.

It then occurs to you that there is another explanation for the busy signal.
The phone might just be broken, in which case it will always give a busy signal.
Find the probability the following four hypotheses:
\begin{table}[h!]
\begin{center}
