...
test. We will also use this example to discuss some issues about the choice
of priors, and to introduce the idea of a {\it hierarchical model}.
...
lifetimes. The results are given below:
\begin{eqnarray}
