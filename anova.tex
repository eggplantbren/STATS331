...
of issues. If we were to re-run the analysis with a narrower prior for the
parameters (for example, by putting the limits at $\pm 100$ instead of 1000),
we would find weaker evidence for $\mu_1 = \mu_2$.
