...
actually implies that the probability they are equal is 0!
...
a uniform distribution between -1000 and 1000.
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{Figures/ttest.pdf}
\caption{\it {\bf Top row: }The three different priors we are trying for our Bayesian
