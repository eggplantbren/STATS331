...
This usually improves the posterior distribution so it is easier to sample,
and also makes it easier to assign a prior for $\beta_0$ (if we want to
assign an informative prior) --- its new meaning is just the typical
value of $y$.
\end{frame}
