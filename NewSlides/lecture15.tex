...
{\tiny
\begin{minted}{r}
> data = read.table("matches.txt", header=TRUE)
> head(data)
  round home_team away_team home_team_score away_team_score
1     1         0         1              28              18
2     1         2         3              15              14
3     1         4         5              52               4
4     1         6         7              42              18
...
\begin{frame}[fragile]
\frametitle{The Data With Extra Column}

{\tiny
\begin{minted}{r}
> data[, "home_team_win"] = as.numeric(data[, "home_team_score"] >
                                       data[, "away_team_score"])
> head(data)
  round home_team away_team home_team_score away_team_score home_team_win
1     1         0         1              28              18             1
2     1         2         3              15              14             1
3     1         4         5              52               4             1
4     1         6         7              42              18             1
...
\end{minted}
\pause
There are two special values. If \mintinline{r}{diversity} is 1, that
...
as well as the posterior distribution for the new \mintinline{r}{diversity}
hyperparameter.
...
\begin{itemize}
\item The posterior distribution for \mintinline{r}{B}, to see how strong
...
one team, we should include \mintinline{r}{B} in the prediction code as well.
\end{itemize}
