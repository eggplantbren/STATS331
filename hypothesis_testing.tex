...
\end{eqnarray}
In case you're curious, the p-value in this case is 0.00031, which is usually
...
for the data values $\{x_1, x_2, ..., x_{100}\}$ was a normal distribution, and
...
value of the parameter that we think is extra plausible.
